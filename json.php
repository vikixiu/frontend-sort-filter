...
$brand = array();
 ...
 for($i=0;$i<1000;$i++)
 {
  ...
  $thistype = $type[$count];
	...
	$productID = rand(0,500); 
	
    $product = array("price"=>$price, "productID"=>$productID, "discount"=>$discount,"brand" =>$thisbrand,"type" =>$thistype,
...
"<dd class='name'>$thisbrand.$i.$thistype.$productID</dd>" .
